...
export function FillDocumentDialog({
  ...
  const handleMailingToggle = (mailingId: string) => {
  ...
  const estimatedDocuments = selectedProviderIds.size * Math.max(1, selectedOfficeIds.size || 1)
              ...
              <TabsContent value="providers" className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant="outline">
                    {selectedProviderIds.size} of {providers.length} selected
                  </Badge>
                </div>
